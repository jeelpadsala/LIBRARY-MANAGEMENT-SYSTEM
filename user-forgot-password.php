...
echo "<script>alert('EMAIL ID OR MOBILE NUMBER NOT EXIST');</script>"; 
}
}
?>
<!DOCTYPE html>
...
<body>
    <div class="container" id="container">
        <div class="form-container sign-in">
            <form role="form" name="chngpwd" method="post" onSubmit="return valid();"><br>
                ...
                <input class="form-control" placeholder="ENER YOUR EMAIL" type="email" name="email" required
                    autocomplete="off" />
                <input class="form-control" placeholder="ENER YOUR MOBILE NUMBER" type="text" name="mobile" required
                    autocomplete="off" />
                <input class="form-control" placeholder="ENER YOUR NEW PASSWORD" type="password" name="newpassword"
                    required autocomplete="off" />
                <input class="form-control" placeholder="ENER YOUR CONFORM PASSWORD" type="password"
